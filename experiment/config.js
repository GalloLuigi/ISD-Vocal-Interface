const Cfg = {
  ...
  "Delete from": "cancella da",
  "Add to": "aggiungi a",
};

export const ExtConfig = {
  Config: Cfg,
  urlToServer: "https://bfb9-128-116-224-56.ngrok-free.app",
  PaperList: {
    [1]: 1,
    [2]: 2,
    [3]: 3,
  ...
  Experiments: {
    ...
    [3]: {
      ...
      "Command 3": Cfg["Correct note"] + " 5 " + "a" + " 6",
      ...
      "Command 13": Cfg["Correct note"] + " 6 " + "a" + " 7",
      "Command 14": "Ricordamelo domani",
      "Command 15": Cfg["Complete Note"],
      "Command 16": Cfg["Approve correction"] + " 1",
    },
    [4]: {
      "Command 1": Cfg["Add numbers to lines"],
      "Command 2": Cfg["Select line"] + " 14",
      "Command 3": Cfg["Correct note"] + " 5 " + "a" + " 6",
      "Command 4": "Correzione effettuata ieri",
      "Command 5": Cfg["Complete Note"],
      "Command 6": Cfg["Select line"] + " 12",
      "Command 7": Cfg["Correct note"] + " 6 " + "a" + " 7",
      "Command 8": "Da eliminare",
      "Command 9": Cfg["Complete Note"],
      "Command 10": Cfg["Approve correction"] + " 2",
      "Command 11": Cfg["Select line"] + " 24",
      "Command 12": Cfg["Correct note"] + " 4 " + "a" + " 7",
      "Command 13": "Correzione effettuata nella scorsa settimana",
      "Command 14": Cfg["Complete Note"],
      "Command 15": Cfg["Approve correction"] + " 2",
      "Command 16": Cfg["Approve correction"] + " 1",
    },
    [5]: {
      "Command 1": Cfg["Add numbers to lines"],
      "Command 2": Cfg["Select lines"] + " 7" + " a" + " 9",
      "Command 3": Cfg["Delete from"] + " 3 " + "a" + " 9",
      "Command 4": Cfg["Select line"] + " 17",
      "Command 5": Cfg["Delete from"] + " 2 " + "a" + " 8",
      "Command 6": Cfg["Select line"] + " 19",
      "Command 7": Cfg["Delete from"] + " 5 " + "a" + " 7",
      "Command 8": Cfg["Select line"] + " 10",
      "Command 9": Cfg["Delete from"] + " 2 " + "a" + " 3",
      "Command 10": Cfg["Select line"] + " 27",
      "Command 11": Cfg["Delete from"] + " 5 " + "a" + " 9",
    },
    [6]: {
      "Command 1": Cfg["Add numbers to lines"],
      "Command 2": Cfg["Select line"] + " 5",
      "Command 3": Cfg["Add to"] + " 2",
      "Command 4": "Si esce prima da lavoro",
      "Command 5": Cfg["Complete Note"],
      "Command 6": Cfg["Delete note"] + " 1",
      "Command 7": Cfg["Select line"] + " 7",
      "Command 8": Cfg["Add to"] + " 1",
      "Command 9": "Ricordamelo il mese prossimo",
      "Command 10": Cfg["Complete Note"],
      "Command 11": Cfg["Select line"] + " 7",
      "Command 12": Cfg["Add to"] + " 5",
      "Command 13": "Urgente",
      "Command 14": Cfg["Complete Note"],
    },
    [7]: {
      ...
      "Command 3": Cfg["Correct note"] + " 1 " + "a" + " 3",
      "Command 4": "Verificare con responsabile",
      "Command 5": Cfg["Complete Note"],
      "Command 6": Cfg["Approve correction"] + " 1",
      ...
      "Command 10": Cfg["Complete Note"],
      "Command 11": Cfg["Select line"] + " 15",
      "Command 12": Cfg["Add to"] + " 8",
      "Command 13": "Uscire prima dal lavoro",
      "Command 14": Cfg["Complete Note"],
      "Command 15": Cfg["Select line"] + " 6",
      "Command 16": Cfg["Delete from"] + " 4 " + "a" + " 9",
    },
  },
  Papers: {
